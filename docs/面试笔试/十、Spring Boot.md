...
JavaConfig 提供了一种类型安全的方法来配置 Spring 容器。由于 Java 5.0 对泛型的支持，现在可以按类型而不是按名称检索 bean，不需要任何强制转换或基于字符串的查找。
...
- [SpringBoot 动态加载配置文件及刷新 Bean - 如.若 - 博客园](https://www.cnblogs.com/rinack/p/14039143.html)
